...
__device__ void cuda_mvm_componentwise_PRECISION(ComponentAccess<cu_cmplx_PRECISION> y, cu_cmplx_PRECISION const *M,
                                                 cu_cmplx_PRECISION const *x) {
  y[0]  = M[0]*x[0];
  y[0] += M[1]*x[1];
  y[0] += M[2]*x[2];
...
__device__ void cuda_mvmh_componentwise_PRECISION(cu_cmplx_PRECISION *y, cu_cmplx_PRECISION const *M,
