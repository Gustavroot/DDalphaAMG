 ...
 *
 * \param[out]  y   The vector y that the result will be written to. Must be a pointer to
 *                  3 consecutive complex values.
 * \param[in]   M   The matrix M. Must be a pointer to 9 consecutive complex values.
 *                  Must be in row-major ordering.
 * \param[in]   x   The vector x. Must be a pointer to 3 consecutive complex values.
 */
