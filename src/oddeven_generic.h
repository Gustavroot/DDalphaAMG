...
struct Thread;
  ...
  void apply_schur_complement_PRECISION_cpu_dummy( vector_PRECISION out, vector_PRECISION in, operator_PRECISION_struct *op, level_struct *l, struct Thread *threading );
